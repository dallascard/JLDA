        ...
        for (int epoch=0; epoch < n_iter; epoch++) {
            ...
            for (int q=0; q < n_tuples; q++) {
                ...
                for (int k = 0; k < n_topics; k++) {
                    pr[k] = Math.exp(Math.log(persona_role_topic_counts[p_j][r_j][k] + beta) + Math.log(topic_vocab_counts[k][v_j] + gamma) - Math.log(topic_tuple_counts[k] + gamma * vocab_size));
